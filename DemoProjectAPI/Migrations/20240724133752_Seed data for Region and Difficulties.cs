    ...
    public partial class SeeddataforRegionandDifficulties : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("46b08cd5-1fa1-493a-aea4-8196b56ac62f"), "Hard" },
                    { new Guid("ed1b493f-e4d3-4d96-9cc6-75c367611469"), "Medium" },
                    { new Guid("f5e114fb-7670-4a32-ab4c-8de70c91312a"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("46b08cd5-1fa1-493a-aea4-8196b56ac62f"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("ed1b493f-e4d3-4d96-9cc6-75c367611469"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f5e114fb-7670-4a32-ab4c-8de70c91312a"));
